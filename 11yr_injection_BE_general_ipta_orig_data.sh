...
python 11yr_injection_BE_general_ipta_orig_data.py -outdir /scratch/nspol/ipta_cut_results/orig_data_ul_wo_prob_psr_noBE/ --psrlist /scratch/nspol/IPTA/partim_cut_IPTA/trunc_psrlist_cut_IPTA_ranked.txt --timpath /scratch/nspol/IPTA/partim_cut_IPTA/ --parpath /scratch/nspol/IPTA/partim_cut_IPTA/ --noisepath /scratch/nspol/IPTA/partim_cut_IPTA/ --dm_var --dm_gp -ul
