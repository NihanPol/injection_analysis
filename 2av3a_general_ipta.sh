...
python 11yr_injection_2av3a_general_ipta.py -realiz 0 -amp_index ${PBS_ARRAYID} -outdir /scratch/nspol/ipta_cut_results/2av3a/ --psrlist /scratch/nspol/IPTA/partim_cut_IPTA/psrlist_cut_IPTA.txt --timpath /scratch/nspol/IPTA/ --parpath /scratch/nspol/IPTA/partim_cut_IPTA/ --noisepath /scratch/nspol/IPTA/partim_cut_IPTA/ --amps_path ipta_amps.npy --dm_var --dm_gp --dm_annual
